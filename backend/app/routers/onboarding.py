...
async def generate_transition_summary(
    ...
    try:
        ...
        emotional_instruction = (
            f'4. "And because of that, it\'s making you feel — I believe you mentioned a little bit... [one-step-down version of their emotion from personal_impact] sometimes…" — include this sentence ONLY because the user provided emotional content.'
