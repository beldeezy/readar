...
export const CHAT_QUESTIONS: ChatQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: '10m_30m', label: '$10 million - $30 million' },
      { value: '30m_100m', label: '$30 million - $100 million' },
  ...
  {
    id: 'book_preferences',
    question: 'Here are 6 popular business books. Rate the ones you know!',
  ...
  },
  {
    ...
    question: 'Upload your Goodreads reading history to get better recommendations! (Optional)',
    type: 'file-upload',
    required: false,
    order: 13,
  },
